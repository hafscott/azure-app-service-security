...
namespace Benday.EasyAuthDemo.UnitTests.MvcControllers
{
    ...
    public class LogEntryControllerFixture
    {
        ...
        private Benday.EasyAuthDemo.WebUi.Controllers.LogEntryController _SystemUnderTest;
        
        private Benday.EasyAuthDemo.WebUi.Controllers.LogEntryController SystemUnderTest
        {
            get
            {
                ...
                {
                    _SystemUnderTest =
                    new Benday.EasyAuthDemo.WebUi.Controllers.LogEntryController(
