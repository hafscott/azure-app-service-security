...
namespace Benday.EasyAuthDemo.UnitTests.MvcControllers
{
    ...
    public class UserControllerFixture
    {
        ...
        private Benday.EasyAuthDemo.WebUi.Controllers.UserController _SystemUnderTest;
        
        private Benday.EasyAuthDemo.WebUi.Controllers.UserController SystemUnderTest
        {
            get
            {
                ...
                {
                    _SystemUnderTest =
                    new Benday.EasyAuthDemo.WebUi.Controllers.UserController(
                    UserServiceInstance,
