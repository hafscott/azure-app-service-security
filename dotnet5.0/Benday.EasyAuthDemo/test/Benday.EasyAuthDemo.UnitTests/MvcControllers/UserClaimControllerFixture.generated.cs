...
namespace Benday.EasyAuthDemo.UnitTests.MvcControllers
{
    ...
    public class UserClaimControllerFixture
    {
        ...
        private Benday.EasyAuthDemo.WebUi.Controllers.UserClaimController _SystemUnderTest;
        
        private Benday.EasyAuthDemo.WebUi.Controllers.UserClaimController SystemUnderTest
        {
            get
            {
                ...
                {
                    _SystemUnderTest =
                    new Benday.EasyAuthDemo.WebUi.Controllers.UserClaimController(
