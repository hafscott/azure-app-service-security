...
using Benday.EasyAuthDemo.UnitTests.Fakes.ServiceLayers;
using Benday.EasyAuthDemo.UnitTests.Utilities;
using Benday.EasyAuthDemo.WebUi.Controllers;
using Benday.EasyAuthDemo.WebUi.Models;
using Benday.EasyAuthDemo.UnitTests.ViewModels;
using Benday.EasyAuthDemo.Api;
using Benday.Common;


namespace Benday.EasyAuthDemo.UnitTests.MvcControllers
{
    [TestClass]
    public class ConfigurationItemControllerFixture
    {
        ...
        private Benday.EasyAuthDemo.WebUi.Controllers.ConfigurationItemController _SystemUnderTest;
        
        private Benday.EasyAuthDemo.WebUi.Controllers.ConfigurationItemController SystemUnderTest
        {
            get
            {
                ...
                {
                    _SystemUnderTest =
                    new Benday.EasyAuthDemo.WebUi.Controllers.ConfigurationItemController(
