...
namespace Benday.EasyAuthDemo.UnitTests.ServiceLayer
{
    ...
    public class PersonServiceFixture
    {
		...
		private InMemoryRepository<Benday.EasyAuthDemo.Api.DataAccess.Entities.PersonEntity> _PersonRepositoryInstance;
        public InMemoryRepository<Benday.EasyAuthDemo.Api.DataAccess.Entities.PersonEntity> PersonRepositoryInstance
        {
            get
            {
                if (_PersonRepositoryInstance == null)
                {
                    _PersonRepositoryInstance = new InMemoryRepository<Benday.EasyAuthDemo.Api.DataAccess.Entities.PersonEntity>();
                }
