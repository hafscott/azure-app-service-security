...
namespace Benday.EasyAuthDemo.UnitTests.Fakes.ServiceLayers
{
    public partial class FakeUserService :
        FakeServiceLayer<Benday.EasyAuthDemo.Api.DomainModels.User>, IUserService
    {
        public IList<Benday.EasyAuthDemo.Api.DomainModels.User> SearchUsingParametersReturnValue { get; set; }
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.User> SimpleSearchReturnValue { get; set; }
