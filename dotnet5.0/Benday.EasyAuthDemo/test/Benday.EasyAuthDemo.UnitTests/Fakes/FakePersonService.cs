...
namespace Benday.EasyAuthDemo.UnitTests.Fakes
{
    public class FakePersonService : 
        FakeServiceLayer<Benday.EasyAuthDemo.Api.DomainModels.Person>, IPersonService
    {
        public IList<Benday.EasyAuthDemo.Api.DomainModels.Person> SearchUsingParametersReturnValue { get; set; }
...
SearchMethod searchTypeLastModifiedBy = SearchMethod.Contains,
		...
		public IList<Benday.EasyAuthDemo.Api.DomainModels.Person> SimpleSearchReturnValue { get; set; }
