...
namespace Benday.EasyAuthDemo.Api.ServiceLayers
{
    public partial class PersonService : 
            ServiceLayerBase<Benday.EasyAuthDemo.Api.DomainModels.Person>, 
            IPersonService
    {
		private ISearchableRepository<Benday.EasyAuthDemo.Api.DataAccess.Entities.PersonEntity> _Repository;
        ...
        public Benday.EasyAuthDemo.Api.DomainModels.Person GetById(int id)
        {
            ...
            {
                var returnValues = new Benday.EasyAuthDemo.Api.DomainModels.Person();
