...
namespace Benday.EasyAuthDemo.Api.ServiceLayers
{
    public partial class UserService :
        CoreFieldsServiceLayerBase<Benday.EasyAuthDemo.Api.DomainModels.User>,
        IUserService
    {
        private IUserRepository _Repository;
        private UserAdapter _Adapter;
        private IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.User> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public UserService(
            IUserRepository repository,
            IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.User> validator,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.User> GetAll(
        ...
        public Benday.EasyAuthDemo.Api.DomainModels.User GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.EasyAuthDemo.Api.DomainModels.User();
        ...
        public void Save(Benday.EasyAuthDemo.Api.DomainModels.User saveThis)
        {
            if (saveThis == null)
            ...
            else
            {
                ...
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.EasyAuthDemo.Api.DataAccess.Entities.UserEntity();
                }
                else
                {
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.User> SimpleSearch(
            string searchValue,
            string sortBy = null,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.User> Search(
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.User> Search(Search search)
        {
            var returnValues = new List<Benday.EasyAuthDemo.Api.DomainModels.User>();
