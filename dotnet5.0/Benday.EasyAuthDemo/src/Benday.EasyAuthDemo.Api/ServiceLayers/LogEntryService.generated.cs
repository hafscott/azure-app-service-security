...
namespace Benday.EasyAuthDemo.Api.ServiceLayers
{
    public partial class LogEntryService :
        ServiceLayerBase<Benday.EasyAuthDemo.Api.DomainModels.LogEntry>,
        ILogEntryService
    {
        private ILogEntryRepository _Repository;
        private LogEntryAdapter _Adapter;
        private IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.LogEntry> _ValidatorInstance;
        private ISearchStringParserStrategy _SearchStringParser;
        
        public LogEntryService(
            ILogEntryRepository repository,
            IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.LogEntry> validator,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.LogEntry> GetAll(
        ...
        public Benday.EasyAuthDemo.Api.DomainModels.LogEntry GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.EasyAuthDemo.Api.DomainModels.LogEntry();
        ...
        public void Save(Benday.EasyAuthDemo.Api.DomainModels.LogEntry saveThis)
        {
            if (saveThis == null)
            ...
            else
            {
                ...
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.EasyAuthDemo.Api.DataAccess.Entities.LogEntryEntity();
                }
                else
                {
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.LogEntry> Search(Search search)
        {
            var returnValues = new List<Benday.EasyAuthDemo.Api.DomainModels.LogEntry>();
