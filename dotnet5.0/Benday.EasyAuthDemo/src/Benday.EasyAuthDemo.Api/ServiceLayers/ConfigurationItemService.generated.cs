...
namespace Benday.EasyAuthDemo.Api.ServiceLayers
{
    public partial class ConfigurationItemService :
        CoreFieldsServiceLayerBase<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem>,
        IConfigurationItemService
    {
        private IConfigurationItemRepository _Repository;
        private ConfigurationItemAdapter _Adapter;
        private IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> _ValidatorInstance;
        ...
        public ConfigurationItemService(
            ...
            IValidatorStrategy<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> validator,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> GetAll(
        ...
        public Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem GetById(int id)
        {
            ...
            {
                var returnValue = new Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem();
        ...
        public void Save(Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem saveThis)
        {
            if (saveThis == null)
            ...
            else
            {
                ...
                if (saveThis.Id == 0)
                {
                    toValue = new Benday.EasyAuthDemo.Api.DataAccess.Entities.ConfigurationItemEntity();
                }
                else
                {
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> SimpleSearch(
            string searchValue,
            string sortBy = null,
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> Search(
        ...
        public IList<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem> Search(Search search)
        {
            var returnValues = new List<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem>();
