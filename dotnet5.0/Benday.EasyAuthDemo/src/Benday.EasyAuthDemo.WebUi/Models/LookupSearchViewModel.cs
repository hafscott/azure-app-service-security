...
{
    public class LookupSearchViewModel : 
		SearchViewModelBase<Benday.EasyAuthDemo.Api.DomainModels.Lookup>
    {
		public LookupSearchViewModel()
		{
			Results = new PageableResults<Benday.EasyAuthDemo.Api.DomainModels.Lookup>();
			IsSimpleSearch = true;
