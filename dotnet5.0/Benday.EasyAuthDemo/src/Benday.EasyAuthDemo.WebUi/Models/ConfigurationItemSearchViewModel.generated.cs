...
namespace Benday.EasyAuthDemo.WebUi.Models
{
    public partial class ConfigurationItemSearchViewModel :
        SearchViewModelBase<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem>
    {
        public ConfigurationItemSearchViewModel()
        {
            Results = new PageableResults<Benday.EasyAuthDemo.Api.DomainModels.ConfigurationItem>();
            IsSimpleSearch = true;
